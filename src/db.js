...
export const SEED_DRINKS = [
  ...
  // ── VODKA COCKTAILS ──
  {
    name: 'Vodka Martini',
    category: 'Cocktail',
    ingredients: ['2.5 oz Vodka', '1/2 oz Dry vermouth', 'Lemon twist or olives (for garnish)', 'Ice'],
    directions: ['Fill a mixing glass with ice.', 'Pour vodka and dry vermouth over ice.', 'Stir for 30 seconds until well-chilled.', 'Strain into a chilled martini glass.', 'Garnish with a lemon twist or olives.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1608889335941-33d1cff32c0a?w=400',
  },
  {
    name: 'White Russian',
    category: 'Cocktail',
    ingredients: ['2 oz Vodka', '1 oz Kahlúa (coffee liqueur)', '1 oz Heavy cream', 'Ice'],
    directions: ['Fill a rocks glass with ice.', 'Pour vodka and Kahlúa over ice.', 'Float heavy cream on top by pouring over the back of a spoon.', 'Stir gently if desired.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Black Russian',
    category: 'Cocktail',
    ingredients: ['2 oz Vodka', '1 oz Kahlúa (coffee liqueur)', 'Ice'],
    directions: ['Fill a rocks glass with ice.', 'Pour vodka and Kahlúa over ice.', 'Stir gently to combine.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    ...
    category: 'Cocktail',
    ingredients: ['2 oz Vodka', '1 oz Kahlúa', '1 oz Fresh espresso (cooled)', '1/2 oz Simple syrup', '3 Coffee beans (for garnish)', 'Ice'],
    directions: ['Brew a shot of espresso and let it cool slightly.', 'Add vodka, Kahlúa, espresso, and simple syrup to a shaker with ice.', 'Shake vigorously for 15 seconds to create a frothy top.', 'Strain into a chilled coupe glass.', 'Garnish with three coffee beans.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1608270861620-7c80a0bc14d6?w=400',
  },
  {
    name: 'Vodka Tonic',
    category: 'Cocktail',
    ingredients: ['2 oz Vodka', '4 oz Tonic water', 'Lime wedge (for garnish)', 'Ice'],
    directions: ['Fill a highball glass with ice.', 'Pour vodka over ice.', 'Top with tonic water.', 'Stir gently.', 'Garnish with a lime wedge.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1607446045875-c4a6f74f9e64?w=400',
  },
  {
    name: 'Cape Codder',
    category: 'Cocktail',
    ingredients: ['2 oz Vodka', '4 oz Cranberry juice', 'Lime wedge (for garnish)', 'Ice'],
    directions: ['Fill a highball glass with ice.', 'Pour vodka over ice.', 'Top with cranberry juice.', 'Stir gently.', 'Squeeze and drop in the lime wedge.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1614707267537-b85faf00021b?w=400',
  },
  {
    name: 'Greyhound',
    category: 'Cocktail',
    ingredients: ['2 oz Vodka', '4 oz Fresh grapefruit juice', 'Grapefruit slice (for garnish)', 'Ice'],
    directions: ['Fill a highball glass with ice.', 'Pour vodka over ice.', 'Top with grapefruit juice.', 'Stir gently.', 'Garnish with a grapefruit slice.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514432543241-edd65efc1d47?w=400',
  },
  {
    name: 'Lemon Drop',
    category: 'Cocktail',
    ingredients: ['2 oz Vodka (citrus preferred)', '1 oz Fresh lemon juice', '3/4 oz Simple syrup', 'Sugar (for rim)', 'Lemon twist (for garnish)', 'Ice'],
    directions: ['Rim a martini glass with sugar using a lemon wedge.', 'Add vodka, lemon juice, and simple syrup to a shaker with ice.', 'Shake vigorously for 15 seconds.', 'Strain into the prepared glass.', 'Garnish with a lemon twist.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1608270861620-7c80a0bc14d6?w=400',
  },
  {
    name: 'Sea Breeze',
    category: 'Cocktail',
    ingredients: ['1.5 oz Vodka', '3 oz Cranberry juice', '1.5 oz Grapefruit juice', 'Lime wedge (for garnish)', 'Ice'],
    directions: ['Fill a highball glass with ice.', 'Pour vodka, cranberry juice, and grapefruit juice.', 'Stir gently.', 'Garnish with a lime wedge.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1614707267537-b85faf00021b?w=400',
  },
  {
    name: 'Bloody Mary',
    category: 'Cocktail',
    ingredients: ['2 oz Vodka', '4 oz Tomato juice', '1/2 oz Fresh lemon juice', '2 dashes Worcestershire sauce', '2 dashes Tabasco', 'Pinch of celery salt', 'Pinch of black pepper', 'Celery stalk and lemon wedge (for garnish)', 'Ice'],
    directions: ['Fill a highball glass with ice.', 'Pour vodka, tomato juice, lemon juice, Worcestershire, and Tabasco.', 'Season with celery salt and pepper.', 'Stir well.', 'Garnish with a celery stalk and lemon wedge.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1608270861620-7c80a0bc14d6?w=400',
  },
  // ── WHISKEY COCKTAILS ──
  {
    name: 'Boulevardier',
    category: 'Cocktail',
    ingredients: ['1.5 oz Bourbon', '1 oz Sweet vermouth', '1 oz Campari', 'Orange peel (for garnish)', 'Ice'],
    directions: ['Fill a mixing glass with ice.', 'Add bourbon, sweet vermouth, and Campari.', 'Stir for 30 seconds.', 'Strain into a rocks glass over a large ice cube.', 'Express an orange peel over the glass and drop it in.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Mint Julep',
    category: 'Cocktail',
    ingredients: ['2.5 oz Bourbon', '1/2 oz Simple syrup', '8-10 Fresh mint leaves', 'Mint sprig (for garnish)', 'Crushed ice'],
    directions: ['Place mint leaves and simple syrup in a julep cup or rocks glass.', 'Gently muddle to release mint oils.', 'Pack the glass with crushed ice.', 'Pour bourbon over ice.', 'Stir until the glass frosts.', 'Top with more crushed ice and garnish with a mint sprig.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Irish Coffee',
    category: 'Cocktail',
    ingredients: ['1.5 oz Irish whiskey', '6 oz Fresh hot coffee', '1 tbsp Brown sugar', '2 oz Lightly whipped cream'],
    directions: ['Warm an Irish coffee glass with hot water, then discard.', 'Add brown sugar and hot coffee, stir until dissolved.', 'Pour in Irish whiskey and stir.', 'Float lightly whipped cream on top by pouring over the back of a spoon.', 'Do not stir — drink the coffee through the cream.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Penicillin',
    category: 'Cocktail',
    ingredients: ['2 oz Blended Scotch', '1/4 oz Islay Scotch (float)', '3/4 oz Fresh lemon juice', '3/4 oz Honey-ginger syrup', 'Candied ginger (for garnish)', 'Ice'],
    directions: ['Add blended Scotch, lemon juice, and honey-ginger syrup to a shaker with ice.', 'Shake vigorously for 15 seconds.', 'Strain into a rocks glass over fresh ice.', 'Float the Islay Scotch on top.', 'Garnish with candied ginger.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Hot Toddy',
    category: 'Cocktail',
    ingredients: ['2 oz Bourbon or Scotch', '1 tbsp Honey', '3/4 oz Fresh lemon juice', '6 oz Hot water', 'Cinnamon stick', 'Lemon wheel (for garnish)'],
    directions: ['Add honey and lemon juice to a mug.', 'Pour in hot water and stir until honey dissolves.', 'Add whiskey and stir.', 'Garnish with a cinnamon stick and lemon wheel.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Rusty Nail',
    category: 'Cocktail',
    ingredients: ['2 oz Scotch', '3/4 oz Drambuie', 'Lemon twist (for garnish)', 'Ice'],
    directions: ['Fill a rocks glass with ice.', 'Pour Scotch and Drambuie over ice.', 'Stir gently to combine.', 'Garnish with a lemon twist.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Whiskey Ginger',
    category: 'Cocktail',
    ingredients: ['2 oz Bourbon or Rye', '4 oz Ginger ale', 'Lime wedge (for garnish)', 'Ice'],
    directions: ['Fill a highball glass with ice.', 'Pour whiskey over ice.', 'Top with ginger ale.', 'Stir gently.', 'Garnish with a lime wedge.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Gold Rush',
    category: 'Cocktail',
    ingredients: ['2 oz Bourbon', '3/4 oz Honey syrup (2:1 honey to water)', '3/4 oz Fresh lemon juice', 'Ice'],
    directions: ['Add bourbon, honey syrup, and lemon juice to a shaker with ice.', 'Shake vigorously for 15 seconds.', 'Strain into a rocks glass over a large ice cube.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
  {
    name: 'Kentucky Mule',
    category: 'Cocktail',
    ingredients: ['2 oz Bourbon', '4 oz Ginger beer', '1/2 oz Fresh lime juice', 'Lime wedge (for garnish)', 'Ice'],
    directions: ['Fill a copper mug or highball glass with ice.', 'Pour bourbon and lime juice over ice.', 'Top with ginger beer and stir gently.', 'Garnish with a lime wedge.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1607446045875-c4a6f74f9e64?w=400',
  },
  {
    name: 'Godfather',
    category: 'Cocktail',
    ingredients: ['2 oz Scotch', '1 oz Amaretto', 'Ice'],
    directions: ['Fill a rocks glass with ice.', 'Pour Scotch and Amaretto over ice.', 'Stir gently to combine.'],
    link: '',
    imageUrl: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400',
  },
